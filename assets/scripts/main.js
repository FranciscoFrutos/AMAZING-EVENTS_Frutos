...
*   -El id de la etiqueta HTML donde se crean las cartas
*   -Una funcion que filtre cada evento segun una condicion 
*/

function createCard(eventsData, elementId, filter) {
    let htmlElement = document.getElementById(elementId);
    eventsData.events.forEach(event => {
        filter(event, htmlElement);
    });
}

/* añadir un evento a un elemento*/
function appendEvent(event, htmlElement){
    let cardElement = document.createElement("div");
    cardElement.innerHTML = getCardTemplate(event);
    let card = cardElement.firstChild;
